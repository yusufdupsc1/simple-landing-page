  ...
  return (
    <>
      <PageHeader
        ...
        description="Manage academic classes and subjects"
      >
                  ...
                  {subjects.length === 0 ? (
                    ...
                    subjects.map((s) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <span
                            className={`inline-flex rounded-full px-2 py-0.5 text-xs font-medium ${s.isCore ? "bg-primary/10 text-primary" : "bg-muted text-muted-foreground"}`}
                          >
