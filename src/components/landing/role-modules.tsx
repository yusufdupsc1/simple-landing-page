      ...
      <div className="glass-card rounded-3xl p-8 sm:p-10 premium-shadow border-primary/10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
          <div className="space-y-2">
            <h2 className="text-3xl font-extrabold tracking-tight text-foreground sm:text-4xl">Govt Primary Office Roles অনুযায়ী</h2>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {roleHighlights.map((item, i) => (
            ...
            >
              <h3 className="text-lg font-bold text-foreground mb-2 group-hover:text-primary transition-colors">{item.role}</h3>
